...
select startID, otherUserID AS destinationID, path from ctename where ctename.otherUserID = $2 AND ctename.startID = $1  
`;
...
router.get('/api/degree', (req, res, next) => {
  db
    .any(
      query,[req.query.startID,req.query.endID],
).then(data => {
